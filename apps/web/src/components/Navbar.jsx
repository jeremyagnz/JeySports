      ...
      <nav className="navbar">
        ...
        {!isFirebaseConfigured && (
          <div className="navbar-demo-notice">
            🎮 Modo Demo — <a href="https://console.firebase.google.com/" target="_blank" rel="noreferrer" aria-label="Configurar Firebase Console">Configura Firebase</a> para usar Google Sign-In real
          </div>
        )}
      </nav>
